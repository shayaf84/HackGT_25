        ...
        ScrollView {
            ...
            if let movementData = manager.movementData {
                VStack(alignment: .leading, spacing: 8) {
                    Text("Movement Data:")
                        .font(.headline)
                    Text("Steps: \(movementData.stepCount)")
                    Text("Stand Hours: \(movementData.standHours)")
                    Text("Active Energy: \(movementData.formattedActiveEnergy)")
                    Text("Exercise: \(movementData.exerciseMinutes) min")
                    Text("Distance: \(movementData.formattedWalkingDistance)")
                    Text("Flights: \(movementData.flightsClimbed)")
                    Text("Movement Score: \(movementData.movementScore)")
                }
            }
            
            // Generated Movement Artwork
